        ...
        <Routes>
          ...
          <Route element={<RequireAuth />}>
            <Route path="/" element={<Layout />}>
              ...
              <Route
                path="/ReimbursementCards"
                element={<ReimbursementCards />}
              />
              <Route
              ...
              <Route
                path="/employee-ContractAndVisaExpiry"
                element={<ContractAndVisaExpiry />}
              />
              <Route
                path="/employee-leaveRequestList"
                element={<LeaveRequestList />}
              />
              <Route
                path="/employee-archived-staff"
