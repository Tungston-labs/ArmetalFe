...
export const useAddCompany = ({
  ...
  useEffect(() => {
    if (isEdit && selectedCompany) {
      ...
      setFormData({
        ...
        house_allowance_percent: selectedCompany.house_allowance_percent ?? "",
        transport_allowance_percent:
          selectedCompany.transport_allowance_percent ?? "",
        special_allowance_percent:
          selectedCompany.special_allowance_percent ?? "",
        working_hours_per_day: selectedCompany.working_hours_per_day ?? "",
  ...
  const validate = () => {
    ...
    const noSalaryFieldErrors =
      !errs.basic_salary_percent &&
    ...
    if (
      ...
      formData.working_hours_per_day === null ||
      formData.working_hours_per_day === undefined
    ) {
    ...
    if (
      ...
      formData.half_day_hours === null ||
      formData.half_day_hours === undefined
    ) {
