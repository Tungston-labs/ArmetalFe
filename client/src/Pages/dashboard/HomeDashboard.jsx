...
import { Container, ContentWrapper, TwoColumn, LeftBox, RightBox, ThreeBox, ThreeColumnRow, TopCard } from "./HomeDashboard.Styles";
...
const holidays = [
  ...
  { name: "X-mas", date: "2025-12-25", type: "National" },
    { name: "Onam", date: "2025-12-25", type: "National" },
      { name: "Vishu", date: "2025-12-02", type: "National" },
...
const contractEmployees = [
  ...
  { name: "Ravi Kumar", empId: "EMP003", expiryDate: "2026-01-05" },
    { name: "Kumar", empId: "EMP003", expiryDate: "2026-01-05" },
];
const recentEmployees = [
  ...
  { name: "Aarav Patel", department: "IT", empId: "EMP103", joiningDate: "2025-01-10" },
   { name: "Roy", department: "HR", empId: "EMP101", joiningDate: "2025-01-02" },
];
