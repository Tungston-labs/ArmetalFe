...
// vi.mock("../../assets/employeeicon.svg", () => "employee-icon.svg");
...
// vi.mock("../../Components/Multistep", () => () => <div data-testid="multistep" />);
// vi.mock("../../Components/UnsavedChangesGuard", () => () => null);
// vi.mock("../../Components/EmployeeTitle", () => () => null);
// vi.mock("../../Components/Loader", () => () => <div data-testid="loader">Loading...</div>);
...
// // requirement for anything referenced inside a vi.mock() factory. The
// // dedicated "JobDetails (sub-component)" tests below bypass this mock with
// // vi.requireActual() to get the real implementation.
...
//  * these tests pull in the REAL implementation via vi.requireActual to
...
//   beforeAll(async () => {
//     JobDetails = (await vi.importActual("../../Components/JobDetails")).default;
//   });
