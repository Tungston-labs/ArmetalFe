...
// AddEmployeeForm.jsx / EmployeeHeader.jsx in your project.
import AddEmployeeForm from "../../Pages/employee/BasicLevel";
...
// JobDetails is mocked file-wide so AddEmployeeForm stays isolated from the
// real JobDetails implementation. Variable names must start with "mock" -
// that's a hard Jest/Vitest requirement for anything referenced inside a
// vi.mock() factory, since vi.mock calls are hoisted above imports/consts.
//
// The real JobDetails implementation is tested separately and thoroughly
// in Jobdetails.test.jsx, which imports the actual component (not this
// mock) to exercise its real validation logic, rendering, and field
// behavior in isolation.
const mockJobDetailsValidate = vi.fn(() => true);
