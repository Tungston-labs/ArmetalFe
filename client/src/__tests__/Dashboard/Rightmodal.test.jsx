...
// vi.mock("../../Components/homepage/AttendanceCircle", () => (props) => (
//   <div data-testid="attendance-circle">{JSON.stringify(props)}</div>
// ));
// vi.mock("../../Components/homepage/SingleHolidayCalendar.jsx", () => (props) => (
//   <div data-testid="holiday-calendar">{JSON.stringify(props)}</div>
// ));
// vi.mock("../../Components/homepage/Notifications", () => (props) => (
//   <div data-testid="notifications">{JSON.stringify(props)}</div>
// ));
// vi.mock("../../Components/homepage/EditProfileModal.jsx", () => (props) => (
//   <div data-testid="edit-profile-modal">{JSON.stringify(props)}</div>
// ));
// vi.mock("../../Components/ChangePasswordModal/ChangePasswordModal.jsx", () => ({ onClose }) => (
