...
class Employee_db(TimeStampedModel):
    ...
    total_leave = models.DecimalField(null=True,blank=True,max_digits=5,decimal_places=2)
    paid_leave = models.DecimalField(null=True,blank=True,max_digits=5,decimal_places=2)
